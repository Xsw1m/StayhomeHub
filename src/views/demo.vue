    ...
    export default {
        ...
        methods: {
            ...
            uploadImage: async function (e) {
                ...
                let fileName =  hour + minu + sec +  Math.round(Math.random()*10) +  Math.round(Math.random()*10) +  Math.round(Math.random()*10) + uploadType
                ...
                // formdata.append('imgStream',this.file);
