<template>
    <div class="header">
        <div class="logo" @click="unregister">
        </div>
        <div class="search">
            <form action="" class="parent">
                ...
                >
                <!--  -->
                <div class="search_btn" @click="unregister"><img src="../img/search.png"></div>
    ...
    <div class="function">
        <div class="history" @click="unregister" tabindex="0"></div>
        <div class="collection" @click="unregister" tabindex="0"></div>
        <div class="download" @click="unregister" tabindex="0"> </div>
        <div class="upload">
            <!-- <upload-drop></upload-drop> -->
        </div>
        <div class="messages" @click="unregister" tabindex="0"><el-badge is-dot class="item" v-if="this.$store.state.news > 0"></el-badge></div>
        <!-- <div class="user" @click="tologin"> -->
            <!-- <user-drop></user-drop> -->
        <!-- </div> -->
        <span style="color:#F4F7FD;font-size:0.73vw;cursor:pointer;" @click="unregister">登录/注册</span>
        <!-- header结束 -->
    </div>
    </div>
</template>
