    ...
    <el-dialog
        ...
        <div style="width:700px;height:420px;">
            ...
            <div style="width:100%;height:420px;display:flex;align-items: center;justify-content: center;">
                <video id="video2" controls="controls"  crossorigin="anonymous" :src= "this.$store.state.Localvideo" style="max-width:100%;max-height:100%"></video>
            </div>
        </div>
        ...
        <span slot="footer" class="dialog-footer">
            <el-button @click="centerDialogVisible = false,pauseVid()">取 消</el-button>
            <el-button type="primary" @click="centerDialogVisible = false,sendPh(),pauseVid()">确 定</el-button>
        </span>
    </el-dialog>
</template>
<script>
